...
public class AdminPanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // On Click of the addEvent Button
        addEventButton.setOnClickListener(new View.OnClickListener() {
                                              ...
                                              public void onClick(View v) {
                                                  ...
                                                  //On save button click we save the Event with its name and wallapaper.
                                                  ...
                                                  // The add wallpaper will open the Photos App and get the photo through the API
        ...
        /*
        The eventView has a click Listener for each object on it that opens the Pepper Activity class
        given the clicked event id as Intent.
         */
